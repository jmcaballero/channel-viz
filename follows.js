(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'tUjBOZmgR3cbyct0HKi0rD80PouMcmoxGg5cUK9lzbIF5FBg', // Unique master Xively API key to be used as a default
		defaultFeeds	= [957558440], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'TAMIC, S.L.', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= 'FFFFFF', // CSS HEX value of color to represent data (omit leading #)
